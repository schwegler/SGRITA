...
class AutosControllerTest < ActionController::TestCase
  ...
  test "should create auto" do
    assert_difference('Auto.count') do
      post :create, auto: { fleet_number: @auto.fleet_number, make: @auto.make, model: @auto.model, year: @auto.year }
    end
  ...
  test "should update auto" do
    put :update, id: @auto, auto: { fleet_number: @auto.fleet_number, make: @auto.make, model: @auto.model, year: @auto.year }
    assert_redirected_to auto_path(assigns(:auto))
  end
